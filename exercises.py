...
def manage_students():
    students = ['Tim', 'Rani', 'Manny' , 'Marquise', 'Polina', 'Mandy', 'Polina', 'Reuben', 'Pete', 'George', 'Gabe', 'Norman']
...
def combine_foods():
    foods = [ 'pizza', 'burger', 'sushi', 'pasta', 'tacos', 'steak', 'pasta', 'sushi', 'burger', 'pizza', 'tacos', 'steak']
    meal = ""
    for food  in foods:
        meal += food + " "
    return meal.strip()
